 ...
 * 
 * This class should not have any JUnit or I/O dependencies/imports, only
 * WebDriver.
 * 
 * @author Michael Vorburger
 */
public class LoggingWebDriverEventListener extends
    ...
    public void afterChangeValueOf(WebElement element, WebDriver driver) {
        try {
            ...
            if ("input".equalsIgnoreCase(tagName)
                ...
                logAndTakeSnapShot(driver, element, "Setting value '"
                        + getValueSafely(element) + "' on");
            }
        } catch (RuntimeException e) {
     ...
     */
    protected void logAndTakeSnapShot(WebDriver driver, WebElement element,
            String log) {
        ...
        if (driver instanceof TakesScreenshot) {
            ...
            File srcFile = takesScreenshotWebDriver
     ...
     * 
     * @param element
     *            the WebElement, to give context, can be null if the previous
     *            message already gave it
     * @param message
     *            the message to log, never null
     * @param screenshot
     *            the Screenshot File, can be null if no screenshot is to be
     *            logged. The File is copied.
     */
    ...
    /**
     * Clearest is an element text (content), if none (e.g. icons) try title,
     * else alt.
     */
    ...
    public void addStyleBeforeSnapShot(WebElement element, WebDriver driver) {
        ...
        if (element != null) {
            ...
            if (webElementId != null && !webElementId.isEmpty()
